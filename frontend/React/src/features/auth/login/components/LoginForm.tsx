    ...
    >
      <div>
        ...
        <input
          ...
          autoComplete="email"
          className="h-12 w-full rounded-xl border border-stone-300 bg-white px-4 text-sm text-stone-950 shadow-sm outline-none transition placeholder:text-stone-400 focus:border-amber-700 focus:ring-4 focus:ring-amber-100 aria-[invalid=true]:border-red-600 aria-[invalid=true]:focus:ring-red-100 dark:border-stone-600 dark:bg-stone-800 dark:text-stone-100 dark:placeholder:text-stone-500 dark:focus:border-amber-500 dark:focus:ring-amber-900/40"
          id="email"
          inputMode="email"
        ...
        {errors.email?.message ? (
          <p className="mt-2 text-sm text-red-700 dark:text-red-400" id="email-error" role="alert">
            {errors.email.message}
          </p>
        ) : null}
      </div>
      ...
      <label className="flex w-fit cursor-pointer items-center gap-3 text-sm text-stone-700 dark:text-stone-300">
        <input
          {...register('rememberMe')}
          className="size-4 rounded border-stone-300 text-amber-800 focus:ring-amber-700 dark:border-stone-600"
          type="checkbox"
        />
