        ...
        <div className="mb-8">
          <div className="rounded-2xl bg-gradient-to-br from-amber-900 to-amber-950 p-7 sm:p-9">
            <div className="flex items-end justify-between gap-4">
              ...
              <button
                className="shrink-0 rounded-xl bg-amber-500 px-4 py-2 text-sm font-semibold text-white transition hover:bg-amber-400"
        ...
        <Card padding="md">
          <div className="flex flex-wrap items-center gap-3">
            <div className="relative flex-1">
              <input
                className="w-full rounded-xl border border-stone-200 bg-white px-4 py-2.5 pl-10 text-sm text-stone-900 placeholder-stone-400 outline-none transition focus:border-amber-400 focus:ring-2 focus:ring-amber-100"
            ...
            <select
              className="rounded-xl border border-stone-200 bg-white px-4 py-2.5 text-sm text-stone-700 outline-none transition focus:border-amber-400 focus:ring-2 focus:ring-amber-100"
              value={statusFilter}
        ...
        <div className="mt-6 overflow-hidden rounded-2xl border border-stone-200 bg-white shadow-sm">
          {loading ? (
            ...
            <div className="py-16 text-center">
              ...
              <h3 className="mt-4 text-lg font-semibold text-stone-600">No clinics found</h3>
              ...
              <table className="w-full text-left text-sm">
                ...
                <tbody className="divide-y divide-stone-100">
                  {data.results.map((clinic) => (
                    ...
                    >
                      <td className="px-5 py-4 font-medium text-stone-900">{clinic.name}</td>
                      <td className="px-5 py-4 text-stone-500">{clinic.email}</td>
                      <td className="px-5 py-4 text-stone-500">{clinic.phone || '—'}</td>
