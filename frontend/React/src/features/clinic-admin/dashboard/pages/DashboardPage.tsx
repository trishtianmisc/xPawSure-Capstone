        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div>
            ...
            <p className="text-sm text-stone-500 dark:text-stone-400">
              Welcome back, {displayName || 'Clinic Admin'}
            </p>
          </div>
          <div className="flex items-center gap-3">
            <div className="h-8 w-8 rounded-full bg-amber-100 flex items-center justify-center text-sm font-bold text-amber-800 dark:bg-amber-900/40 dark:text-amber-300">
        ...
        {isLoading ? (
          ...
          <>
            <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              />
              <StatCard
                icon={<svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} /></svg>}
                label="Registered Pets"
                trend={{ direction: 'up', value: '8%' }}
                value={data.stats.total_pets}
              />
              <StatCard
                icon={<svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} /></svg>}
